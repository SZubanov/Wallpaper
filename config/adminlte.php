    ...
    */
    ...
    'menu' => [
        [
            ...
            'active'      => ['categories', 'regex:@^categories/[0-9]+$@', 'regex:@^categories/[A-z]+$@', 'regex:@^categories/[0-9]+/[A-z]+$@']
        ],
        [
            'text'        => 'wallpapers',
            ...
            'icon_color'  => 'red',
            'active'      => ['wallpapers', 'regex:@^wallpapers/[0-9]+$@', 'regex:@^wallpapers/[A-z]+$@', 'regex:@^wallpapers/[0-9]+/[A-z]+$@']
        ],
        [
            'text'        => 'users',
            'route'       => 'users.index',
        ...
        [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/datatables/js/buttons.bootstrap4.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/datatables/js/buttons.colVis.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                ...
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/datatables/css/buttons.bootstrap4.min.css',
                ],
            ],
        ],
        'Sweetalert2'     => [
        ...
        [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/fancybox/fancybox.min.css',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/fancybox/jquery.fancybox.min.js',
                ],
            ],
        ],
